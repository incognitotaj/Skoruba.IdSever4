...
using IdSever4.STS.Identity.Configuration;
using IdSever4.STS.Identity.Configuration.ApplicationParts;
using IdSever4.STS.Identity.Configuration.Constants;
using IdSever4.STS.Identity.Configuration.Interfaces;
using IdSever4.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace IdSever4.STS.Identity.Helpers
{
