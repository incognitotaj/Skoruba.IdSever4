...
using IdSever4.Admin.Api.Configuration;
using IdSever4.Admin.Api.Configuration.Authorization;
using IdSever4.Admin.Api.ExceptionHandling;
using IdSever4.Admin.Api.Helpers;
using IdSever4.Admin.Api.Mappers;
using IdSever4.Admin.Api.Resources;
using IdSever4.Admin.EntityFramework.Shared.DbContexts;
using IdSever4.Admin.EntityFramework.Shared.Entities.Identity;
using Skoruba.IdentityServer4.Shared.Configuration.Helpers;
using IdSever4.Shared.Dtos;
using IdSever4.Shared.Dtos.Identity;

namespace IdSever4.Admin.Api
{
