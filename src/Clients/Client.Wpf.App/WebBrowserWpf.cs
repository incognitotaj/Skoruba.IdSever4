...
{
    internal class WebBrowserWpf : IBrowser
    {
        ...
        /// </code>
        /// </example>
        public WebBrowserWpf(Func<Window> windowFactory, bool shouldCloseWindow = true)
        {
        ...
        public WebBrowserWpf(string title = "Authenticating...", int width = 1024, int height = 768)
            : this(() => new Window
            {
